deptbasic_boardbasic_board-- 부서 테이블 제거하기
-- DROP TABLE EMP;
-- 사원 테이블 제거하기
-- DROP TABLE DEPT;
-- 급여 테이블 제거하기
...
INSERT INTO EMP VALUES(1006, '장동건', '부장', 1008, DATE_FORMAT('2003-10-09','%Y-%m-%d %H"%i%s'), 480, NULL, 30);basic_student
...
, STU_AGE
, STU_TEL
, (KOR_SCORE + ENG_SCORE + MATH_SCORE) TOTAL
FROM basic_student;

SELECT 123.456, ROUND(123.456, 1), ROUND(123.456, 2);

SELECT
ROUND(KOR_SCORE + ENG_SCORE + MATH_SCORE / 3 , 2) TOTAL
FROM basic_student;
